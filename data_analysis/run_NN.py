...
def run_NN(X_train, y_train, X_test, y_test, class_names=[], CV_suffix = "", param_grid=None, n_jobs=-1, opt = None, time_window = None):
    ...
    if opt==True:
        ...
        grid_search = GridSearchCV(estimator=model, param_grid=param_grid, 
                                        cv=StratifiedKFold(3), n_jobs=n_jobs)
...
def run_NN_with_feature_tuning(train_df_per_space, test_df_per_space, class_names=[], CV_suffix = "", param_grid=None, n_jobs=-1, opt = None, time_window = None, label_mapping=None,
